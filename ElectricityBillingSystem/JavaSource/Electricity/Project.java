...
public class Project extends JFrame implements ActionListener {
    ...
    String medidor;
    Project(String medidor, String pessoa){
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            new PayBill(medidor).setVisible(true);
            ...
            new GenerateBill(medidor).setVisible(true);
            
        }else if(msg.equals("Deposit Details")){
            new DepositDetails().setVisible(true);
        }else if(msg.equals("View Information")){
            new ViewInformation(medidor).setVisible(true);
        }else if(msg.equals("Update Information")){
            new UpdateInformation(medidor).setVisible(true);
        }else if(msg.equals("Bill Details")){
            new BillDetails(medidor).setVisible(true);
        }
