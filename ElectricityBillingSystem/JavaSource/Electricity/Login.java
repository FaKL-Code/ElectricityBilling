...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        b2 = new JButton("Cancel", new ImageIcon(i1));
        b2.setBounds(330, 160, 100, 20);
        add(b2);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            try{        
                ...
                String q  = "select * from login where username = '"+a+"' and password = '"+b.toString()+"' and user = '"+user+"'";
                ResultSet rs = c.state.executeQuery(q);
                if(rs.next()){
